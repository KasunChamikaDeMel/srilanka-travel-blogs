...
export default function WellnessAyurveda() {
  return (
    <MaxWidthWrapper className="my-10 space-y-10">
      <section className="text-center">
        <h1 className="text-5xl font-bold text-gray-800 mb-4">Wellness & Ayurveda</h1>
        <p className="text-lg text-gray-600">
          Rejuvenate your mind and body with ancient wellness practices and Ayurvedic therapies.
        </p>
      </section>

      <section className="p-6 rounded-lg shadow-lg bg-gray-100">
        <h2 className="text-3xl font-semibold text-gray-800 mb-4">Top Wellness Destinations</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="h-40 bg-cover bg-center" style={{ backgroundImage: "url('/images/spa.jpg')" }}></div>
            <div className="p-4">
              <h3 className="text-xl font-semibold text-gray-800">Luxury Spa Resorts</h3>
              <p className="text-sm text-gray-600 mt-2">
                Relax and unwind with premium spa treatments in serene surroundings.
              </p>
              <a href="#" className="text-blue-500 hover:text-blue-700 mt-4 block">Learn More &rarr;</a>
            </div>
          </div>
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="h-40 bg-cover bg-center" style={{ backgroundImage: "url('/images/ayurveda.jpg')" }}></div>
            <div className="p-4">
              <h3 className="text-xl font-semibold text-gray-800">Ayurvedic Retreats</h3>
              <p className="text-sm text-gray-600 mt-2">
                Restore balance with traditional Ayurvedic treatments and therapies.
              </p>
              <a href="#" className="text-blue-500 hover:text-blue-700 mt-4 block">Learn More &rarr;</a>
            </div>
          </div>
