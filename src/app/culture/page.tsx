...
export default function CulturalExploration() {
  return (
    <MaxWidthWrapper className="my-10 space-y-10">
      <section className="text-center">
        <h1 className="text-5xl font-bold text-gray-800 mb-4">Cultural Exploration</h1>
        <p className="text-lg text-gray-600">
          Dive into the rich cultural heritage and traditions of fascinating destinations around the world.
        </p>
      </section>

      <section className="p-6 rounded-lg shadow-lg bg-gray-100">
        <h2 className="text-3xl font-semibold text-gray-800 mb-4">Top Cultural Destinations</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="h-40 bg-cover bg-center" style={{ backgroundImage: "url('/images/temple.jpg')" }}></div>
            <div className="p-4">
              <h3 className="text-xl font-semibold text-gray-800">Ancient Temples of Southeast Asia</h3>
              <p className="text-sm text-gray-600 mt-2">
                Explore centuries-old temples and immerse yourself in history and spirituality.
              </p>
              <a href="#" className="text-blue-500 hover:text-blue-700 mt-4 block">Learn More &rarr;</a>
            </div>
          </div>
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="h-40 bg-cover bg-center" style={{ backgroundImage: "url('/images/festival.jpg')" }}></div>
            <div className="p-4">
              <h3 className="text-xl font-semibold text-gray-800">Festivals Around the World</h3>
              <p className="text-sm text-gray-600 mt-2">
                Join vibrant festivals and experience local customs, music, and dance.
              </p>
              <a href="#" className="text-blue-500 hover:text-blue-700 mt-4 block">Learn More &rarr;</a>
            </div>
          </div>
