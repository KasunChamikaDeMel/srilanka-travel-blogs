...
export default function BeachVacation() {
  return (
    <MaxWidthWrapper className="my-10 space-y-10">
      <section className="text-center animate-fadeInUp animate-slideUp delay-100">
        <h1 className="text-5xl font-bold text-gray-800 mb-4">Relaxation & Beach Vacation</h1>
        <p className="text-lg text-gray-600">
          Find your perfect beach escape and unwind on beautiful, sun-kissed shores.
        </p>
      </section>

      <section className="p-6 rounded-lg shadow-lg bg-gray-100 animate-fadeInUp animate-slideUp delay-400">
        <h2 className="text-3xl font-semibold text-gray-800 mb-4">Top Beach Destinations</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="h-40 bg-cover bg-center" style={{ backgroundImage: "url('/images/trinco.jpg')" }}></div>
            <div className="p-4">
              <h3 className="text-xl font-semibold text-gray-800">Uppuveli Beach, Trincomalee</h3>
              <p className="text-sm text-gray-600 mt-2">
                Enjoy the white sandy beaches and turquoise waters of the Trincomalee.
              </p>
              <a href="#" className="text-blue-500 hover:text-blue-700 mt-4 block">Explore &rarr;</a>
            </div>
          </div>
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="h-40 bg-cover bg-center" style={{ backgroundImage: "url('/images/mirissa.jpg')" }}></div>
            <div className="p-4">
              <h3 className="text-xl font-semibold text-gray-800">Mirissa, Matara</h3>
              <p className="text-sm text-gray-600 mt-2">
                Experience the aloha spirit and stunning beaches of Matara.
              </p>
              <a href="#" className="text-blue-500 hover:text-blue-700 mt-4 block">Explore &rarr;</a>
            </div>
          </div>
